...
export default function Content_stack() {
  ...
  return (
    <div className="m-0 flex w-[75vw] max-w-[75vw] flex-col pl-1 pt-10 font-RobotoCondensed text-xl text-white">
      <div className="flex w-full flex-col" ref={lang}>
        <div className="pb-10 font-impact text-3xl">Languages</div>
        <div className="flex flex-col justify-evenly gap-10 pb-10 *:*:size-20">
      ...
      <div className="flex w-full flex-col" ref={frame}>
        ...
        <div className="flex flex-col justify-evenly gap-10 pb-10 *:*:size-24">
          ...
          <div className="flex flex-row justify-evenly gap-5 *:*:size-20">
            <div className="item text-center">
              <img
                src={nodelogo}
                alt="Image"
      ...
      <div className="flex w-full flex-col" ref={data}>
        ...
        <div className="flex flex-col justify-evenly *:*:size-20 gap-10 pb-10">
